...
export const listSeedProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('https://agrohub-backend.vercel.app/api/seeds')
...
export const deleteSeedProducts = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`https://agrohub-backend.vercel.app/api/seeds/${id}`, config)
...
export const createSeedProducts = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`https://agrohub-backend.vercel.app/api/seeds`, {}, config)
...
export const updateSeedProducts = (seed) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`https://agrohub-backend.vercel.app/api/seeds/${seed._id}`, seed, config)
...
export const createProductReview = (productId, review) => async (
    ...
    try {
      ...
      await axios.post(`https://agrohub-backend.vercel.app/api/seeds/${productId}/reviews`, review, config)
