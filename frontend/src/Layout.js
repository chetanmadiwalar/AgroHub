...
import FarmerDashboard from './screens/Farmer_Dashboard/farmerDashboard.jsx';
import SupplierDashboard from './screens/Supplier_Dashboard/supplierDashboard.jsx';
...
import farmerMyProducts from './screens/farmerMyproducts/farmerMyProducts'
import MyOrdersScreen from './screens/MyOrders/MyOrdersScreen';
import SupplierMyProducts from './screens/SupplierMyProducts/SupplierMyProducts';
import SupplierMyMachines from './screens/SupplierMyMachines/SupplierMymachines.jsx';
const Layout = () => {
    return (
        <>
            <Router>
                ...
                <Switch>
                    ...
                    <Route exact path="/farmers/products" component={farmerMyProducts} />
                    ...
                    <Route exact path="/supplier/myproducts" component={SupplierMyProducts} />
                    <Route exact path="/supplier/mymachines" component={SupplierMyMachines} />
                    ...
                    <Route exact path="/farmers/dashboard" component={FarmerDashboard} />
                    <Route exact path="/farmers/lendMachines/:id" component={LendMachineProduct} />
                    <Route exact path="/farmer/add-product" component={ConsumerListEdit} />
